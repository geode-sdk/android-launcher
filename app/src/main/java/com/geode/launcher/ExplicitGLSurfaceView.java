 ...
 *
 * Original code from <https://android.googlesource.com/platform/frameworks/base/+/1cdfff555f4a21f71ccc978290e2e212e2f8b168/opengl/java/android/opengl/GLSurfaceView.java>
 * Modified to support EGL14 and additional frame pacing (mNativeFramePacing).
 */
...
public class ExplicitGLSurfaceView extends SurfaceView implements SurfaceHolder.Callback2 {
    private final static String TAG = "ExplicitGLSurfaceView";
     ...
     */
    public ExplicitGLSurfaceView(Context context) {
        super(context);
        init();
    }
    /**
     ...
     * must call {@link #setRenderer} to register a renderer.
     */
    public ExplicitGLSurfaceView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    @Override
     ...
     * this interface, and then call {@link ExplicitGLSurfaceView#setRenderer} to
     ...
     * use the {@link ExplicitGLSurfaceView#queueEvent(Runnable)} convenience method.
     * <p>
     ...
     * {@link ExplicitGLSurfaceView#setEGLContextFactory(EGLContextFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link ExplicitGLSurfaceView#setEGLWindowSurfaceFactory(EGLWindowSurfaceFactory)}
     */
     ...
     * <p>
     * This interface must be implemented by clients wishing to call
     * {@link ExplicitGLSurfaceView#setEGLConfigChooser(EGLConfigChooser)}
     */
    ...
    private static class EglHelper {
        ...
        public void start() {
            ...
            ExplicitGLSurfaceView view = mGLSurfaceViewWeakRef.get();
            if (view == null) {
                mEglConfig = null;
                mEglContext = null;
            } else {
        ...
        private WeakReference<ExplicitGLSurfaceView> mGLSurfaceViewWeakRef;
    ...
    static class GLThread extends Thread {
        GLThread(WeakReference<ExplicitGLSurfaceView> glSurfaceViewWeakRef) {
            super();
            mWidth = 0;
            mHeight = 0;
            mRequestRender = true;
    ...
    private final WeakReference<ExplicitGLSurfaceView> mThisWeakRef =
            new WeakReference<ExplicitGLSurfaceView>(this);
